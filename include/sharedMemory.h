...
#define BAYSCURRENTINFOMUTEX_OFFSET (BUSESOUTGOINGMUTEX_OFFSET + BUSESOUTGOINGMUTEX_SIZE)
#define MESSAGESENTMUTEX_OFFSET (BAYSCURRENTINFOMUTEX_OFFSET + BAYSCURRENTINFOMUTEX_SIZE)
...
#define SHAREDMEMORY_SIZE (STATIONMANAGERINCOMINGMUTEX_SIZE + STATIONMANAGEROUTGOINGMUTEX_SIZE + BUSESMUTEX_SIZE + BUSESOUTGOINGMUTEX_SIZE + BAYSCURRENTINFOMUTEX_SIZE + MESSAGESENTMUTEX_SIZE + MESSAGEREADMUTEX_SIZE + MESSAGESENT2MUTEX_SIZE + MESSAGEREAD2MUTEX_SIZE + INCOMINGBUSESCOUNTMUTEX_SIZE + OUTGOINGBUSESCOUNTMUTEX_SIZE + INCOMINGBUSESCOUNT_SIZE + OUTGOINGBUSESCOUNT_SIZE + BAYCAPACITYPERTYPE_SIZE + BUSTYPE_SIZE + BUSPID_SIZE + PASSENGERSCOUNT_SIZE + BAYTYPE_SIZE + ISLEINDEX_SIZE + INCOMINGMANTIME_SIZE + OUTGOINGMANTIME_SIZE)
